...
After preprocess, a series of *19* Double-Stream Transformer blocks are applied. Those blocks employ separate weights for image and text tokens. Multi-modality is achieved by applying the attention operation over the concatenation of the tokens, ass iluustrated in Figure [7b]("figure-7b").
...
[^huang2017arbitrary]: Huang, Xun and Belongie, Serge, "Arbitrary style transfer in real-time with adaptive instance normalization" (2017).
